 ...
 */
@Entity
@Table(name = "ADMININFO", catalog = "", schema = "SYSTEM")
@NamedQueries({
    ...
    , @NamedQuery(name = "Admininfo.findByUsername", query = "SELECT a FROM Admininfo a WHERE a.username = :username")
...
public class Admininfo implements Serializable {
    ...
    public Admininfo(BigDecimal id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "bus.management.Admininfo[ id=" + id + " ]";
    }
